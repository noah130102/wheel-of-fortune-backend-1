...
const defaults = {
    ...
    SMTP: {
        TRANSPORT: {
            ...
            host: process.env.NODEMAILER_HOST || "smtp-relay.brevo.com",
            service: process.env.NODEMAILER_SERVICE || 'node-mailer-service',
            auth: {
                user: process.env.NODEMAILER_USER || "775149001@smtp-brevo.com",
                pass: process.env.NODEMAILER_PASSWORD || 'Hrf85YPBzGFZtCq2',
            },
            secure: false,
    ...
    MONGODB: {
        ...
        NAME: process.env.DB_NAME || 'wheelOfFortune',
