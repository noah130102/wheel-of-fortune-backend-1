module.exports = {
  ...
  VERIFICATION_MAIL_SENT:
    "A verfification mail has been sent to you registered email address.",
  VERIFY_EMAIL_BEFORE_LOGIN:
    "Your email has not been verified yet, please verify your email before login.",
  SALESAGENT_NOT_APPROVED:
    "Your account has not been approved by the admin yet, please contact the admin.",
  ...
  USER_NOT_EXIST: "User Does'nt exists",
  ...
  PAYMENT_NOT_PROCESSED: "Your payment will be processed late on.",
  NO_CREDIT_REQ: "No Credit requests found !!",
  NO_TRANSACTION_FOUND: "No transactions found for user"
};
